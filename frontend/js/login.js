(function() {
    ...
    const LOGIN_LABEL_FALLBACKS = {
        ...
        introEyebrow: "INIT Data Editing System",
        introHeadline: "Understand your data.",
        introHeadlineAccent: "Build rules you can trust.",
        introLead: "Analyze columns and distributions, discover editing rules, validate violations, and run every workflow with a traceable history.",
        introFlowKicker: "DATA EDITING FLOW",
        introVisualProfile: "Profile",
        introVisualDiscover: "Discover",
        introVisualValidate: "Validate",
        introVisualExecute: "Execute",
        introStepProfile: "Data profiling",
        introStepProfileDesc: "Column, distribution, and relationship insights",
        introStepRule: "Rule evidence",
        introStepRuleDesc: "Review violations, scores, and evidence",
        introStepRun: "Governed execution",
        introStepRunDesc: "Track flows, schedules, and run history",
        loginId: "Login ID",
        password: "Password",
