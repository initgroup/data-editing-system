(function() {
    ...
    const LOGICAL_DATA_DOMAINS = {
        M00001: ["파일 입수", "프로젝트/시나리오 자동 준비", "통합 FLOW 실행 상태", "분석 출처별 규칙/위반 결과"],
        ...
        M06001: ["프로젝트·시나리오", "M04001 Flow 설계·실행 기준", "M04002 분석 결과", "M05001~M05003 에디팅 결과", "고정 21종 개별·통합 보고서"],
    ...
    const SQL_PURPOSES = {
        ...
        M99001: ["DB 연결 설정", "스키마 상태/초기화", "PL/SQL 모델 객체 그룹 배포", "bootstrap 로그"],
