...
BEGIN
    ...
    truncate_table_if_exists('INIT$_TB_RULEVIOL_SYMBOLIC');
    truncate_table_if_exists('INIT$_TB_RULEDISC_SYMBOLIC');
    truncate_table_if_exists('INIT$_TB_COLREL_LASSO_FEATURE');
    truncate_table_if_exists('INIT$_TB_COLREL_NETWORK_EDGE');
    truncate_table_if_exists('INIT$_TB_COLREL_NETWORK_NODE');
    truncate_table_if_exists('INIT$_TB_COLREL_SUMMARY');
    truncate_table_if_exists('INIT$_TB_COLREL_PAIR');
    truncate_table_if_exists('INIT$_TB_COLREL_NUM_SUMMARY');
    truncate_table_if_exists('INIT$_TB_COLREL_NUM_PAIR');
    truncate_table_if_exists('INIT$_TB_API_RESULT');
    truncate_table_if_exists('INIT$_TB_COLREL_CAT_SUMMARY');
    truncate_table_if_exists('INIT$_TB_COLREL_CAT_PAIR');
    truncate_table_if_exists('INIT$_TB_RULEVIOL_ASSOC');
    truncate_table_if_exists('INIT$_TB_RULEDISC_ASSOC_SUM');
    truncate_table_if_exists('INIT$_TB_COLTYPE_FINAL');
    truncate_table_if_exists('INIT$_TB_COLTYPE_RESULT');
