...
SELECT MAX("MODEL_NAME") AS PHYSICAL_MODEL_NAME
     , MAX("MODEL_VERSION_ID") AS MODEL_VERSION_ID
     ...
     , SUM(CASE WHEN "MODL_PREDICTED_TYPE" IS NOT NULL THEN 1 ELSE 0 END) AS MODEL_PREDICTED_ROW_COUNT
